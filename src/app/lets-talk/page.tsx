...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Let's Talk - Architecture Consulting",
    description:
        ...
        <main className="article">
          ...
          <div className="article-content">
            <p>
              ...
              Engineer at HelloFresh, working on AI-driven customer service and
              modernizing platforms that have seen better days.
            </p>

            <p>
              Software should be a craft, not something we constantly apologize
              for. I&apos;ve seen too many systems that work great in demos but
              collapse under real load. My focus is building things that
              actually work — and that your team can sleep soundly knowing they
              won&apos;t break at 3 AM.
            </p>
            ...
            <p>
              ...
              fire&quot; experience
              <br />• Built AI chatbots that help instead of making people want
              to throw their phones
            </p>

            <h2>Tech I Work With</h2>

            <p>
              Started with Java (13 years, even got the Oracle cert to prove it)
              but recently fell hard for Go. If you&apos;ve read my blog, you
              know the story. These days it&apos;s mostly Go, AWS (Bedrock, EKS,
              the usual suspects), and enough JavaScript/TypeScript to be
              dangerous.
            </p>

            <p>
              I&apos;m exploring Rust because memory safety without garbage
              collection is pretty compelling. But honestly? I&apos;m suspicious
              of anything that looks too clever. Simple usually wins.
            </p>
            ...
            <p>
              ...
              about what you&apos;re dealing with, see if it makes sense, and go
              from there.
            </p>
